...
> = ({ children, className, ...props }) => {
  return (
    <select
      className={`h-full bg-primary-700 text-primary-100 placeholder-primary-300 focus:outline-none rounded px-4 appearance-none bg-no-repeat bg-auto ${className}`}
      style={{
        backgroundImage:
